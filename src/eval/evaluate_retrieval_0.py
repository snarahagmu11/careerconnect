...
# -----------------------------------------------------------
# FINAL 10 EVALUATION QUERIES (balanced mix)
# -----------------------------------------------------------

EVAL_QUERIES = [
    # STRONG MATCHES (present in dataset)
    "Supply Chain Analyst",
    "Systems Administrator",
    "Support Specialist",
    "Supervisor/Manager Part-Time",

    # MEDIUM MATCHES (close variants)
    "Supplier Quality Engineer",
    "Supply Chain Coordinator",
    "System Engineer",

    # WEAK MATCHES (not present)
...
# -----------------------------------------------------------
# GROUND TRUTH (titles you actually have)
# -----------------------------------------------------------
...
GROUND_TRUTH = {
    ...
    # Weak matches (no exact matches expected)
    "AI Research Scientist": [],
    "Nurse Practitioner Technician": [],
    "Blockchain Developer": [],
}
